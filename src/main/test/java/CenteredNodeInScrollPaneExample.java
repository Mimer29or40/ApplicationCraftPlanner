...
public class CenteredNodeInScrollPaneExample extends Application
{
    ...
    public void start(final Stage stage) throws Exception
    {
        ...
        effect.setOnAction(actionEvent -> {
        ...
        // align the node.
        topLeft.setOnAction(actionEvent -> {
        ...
        showSquare.setOnAction(actionEvent -> {
        ...
        showGraph.setOnAction(actionEvent -> {
...
//    nodeContainer.setManaged(false);
    ...
    { // create a graph node to be acted on by the controls.
        // setup graph
        ...
        for (int x = 0; x <= 10; x++) series.getData().add(new XYChart.Data<>(x, x * x));
